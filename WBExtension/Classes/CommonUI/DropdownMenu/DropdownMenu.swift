...
open class DropdownMenu: UIView {
    ...
    open var selectRowAtIndexPathHandler: ((_ indexPath: IndexPath) -> ())?
    open var dismissMenuHandler:(() -> ())?
    ...
    open func showMenu(isOnNavigaitionView: Bool = false) {
        ...
        UIView.animate(withDuration: animateDuration, delay: 0, options: UIViewAnimationOptions.init(rawValue: 7<<16), animations: {
